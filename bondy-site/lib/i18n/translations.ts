  ...
  en: {
    ...
    nav: {
      ...
      resourcesMenu: {
        ...
        recruitersDesc: 'Curated HR & recruiting roles across LATAM',
        recruitersHref: 'https://tools.wearebondy.com/recursos-recruiters/busco-trabajo',
        hiringTitle: 'For hiring managers',
        hiringDesc: 'Open searches and how we partner with engineering teams',
        hiringHref: '/en/services',
        candidatesTitle: 'For candidates',
        candidatesDesc: 'Browse 3,700+ open tech roles in LATAM',
        candidatesHref: 'https://tools.wearebondy.com/busco-trabajo',
        thinkingTitle: 'Thinking',
        thinkingDesc: 'Notes on technical hiring, retention, and the LATAM market',
        thinkingHref: '/en/thinking',
      },
    },
  ...
  es: {
    nav: {
      ...
      resourcesMenu: {
        ...
        recruitersDesc: 'Búsquedas curadas de HR y recruiting en LATAM',
        recruitersHref: 'https://tools.wearebondy.com/recursos-recruiters/busco-trabajo',
        hiringTitle: 'Para hiring managers',
        hiringDesc: 'Búsquedas abiertas y cómo trabajamos con equipos de ingeniería',
        hiringHref: '/es/services',
        candidatesTitle: 'Para candidatos',
        candidatesDesc: 'Explorá 3.700+ búsquedas tech abiertas en LATAM',
        candidatesHref: 'https://tools.wearebondy.com/busco-trabajo',
        thinkingTitle: 'Ideas',
        thinkingDesc: 'Notas sobre hiring técnico, retención y el mercado LATAM',
        thinkingHref: '/es/thinking',
      },
    },
