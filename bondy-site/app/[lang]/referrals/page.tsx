...
const copy = {
  en: {
    ...
    h1a: 'Know someone',
    h1b: 'great?',
    intro: "If you know a senior tech professional who's open to new opportunities — and they end up getting placed through Bondy — we'll pay you a bonus. Up to USD 1,000 depending on the role.",
    ...
    steps: [
      ...
      { n: '04', title: 'You get paid', body: "Transferred directly to you. We'll reach out to confirm the details once the placement is confirmed." },
    ],
    bonusLabel: 'Referral bonus',
    bonusUSD: 'USD 1,000',
    bonusARS: 'ARS 650.000',
    bonusUSDDesc: 'when placed in a role paid in USD',
    bonusARSDesc: 'when placed in a role paid in ARS',
    ...
    finePrint: 'The bonus is paid after the referred candidate completes 3 months in the role. The amount depends on the currency of the role: USD 1,000 if the placement is in a USD-paid role, ARS 650.000 if the role is in ARS. Only one bonus per unique referral. Bondy employees are not eligible.',
  },
  es: {
    label: 'Referidos',
    h1a: '¿Conocés a',
    h1b: 'alguien muy bueno?',
    intro: 'Si referís a un profesional tech senior que esté abierto a nuevas oportunidades — y termina siendo colocado a través de Bondy — te pagamos un bono. Hasta USD 1.000 según el rol.',
    ...
    steps: [
      ...
      { n: '04', title: 'Cobras', body: 'Transferidos directamente a vos. Te contactamos para confirmar los datos una vez confirmada la colocación.' },
    ],
    bonusLabel: 'Bono por referido',
    bonusUSD: 'USD 1.000',
    bonusARS: 'ARS 650.000',
    bonusUSDDesc: 'si entra en un rol pago en USD',
    bonusARSDesc: 'si entra en un rol pago en ARS',
    ...
    finePrint: 'El bono se paga una vez que el candidato referido completa 3 meses en el rol. El monto depende de la moneda del rol: USD 1.000 si la colocación es en un rol pago en USD, ARS 650.000 si el rol es en ARS. Sólo un bono por referido único. Los empleados de Bondy no son elegibles.',
  },
}
    ...
    <main style={{ backgroundColor: tw.bg, backgroundImage: notebookBg, minHeight: '100vh' }}>
      ...
      <header style={{ borderBottom: `1px solid ${tw.rule}` }}>
        <div className="ref-hero-grid">
          ...
          {/* Right — bonus callout en verde, dual USD / ARS */}
          <div style={{ background: tw.green, padding: 'clamp(2.5rem,5vw,4rem) clamp(1.25rem,4vw,3.5rem)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1.25rem' }}>
              <div>
                <div style={{ fontFamily: serif, fontSize: 'clamp(2.5rem,6vw,4rem)', lineHeight: 1, color: '#FFFFFF' }} className="tw-ink-heavy">
                  {c.bonusUSD}
                </div>
                <div style={{ fontFamily: mono, fontSize: '11px', letterSpacing: '0.08em', color: 'rgba(255,255,255,0.78)', marginTop: '0.4rem' }}>
                  {c.bonusUSDDesc}
                </div>
              </div>
              <div style={{ borderTop: '1px solid rgba(255,255,255,0.25)', paddingTop: '1.25rem' }}>
                <div style={{ fontFamily: serif, fontSize: 'clamp(2.5rem,6vw,4rem)', lineHeight: 1, color: '#FFFFFF' }} className="tw-ink-heavy">
                  {c.bonusARS}
                </div>
                <div style={{ fontFamily: mono, fontSize: '11px', letterSpacing: '0.08em', color: 'rgba(255,255,255,0.78)', marginTop: '0.4rem' }}>
            ...
            <p style={{ fontFamily: mono, fontSize: '10px', letterSpacing: '0.12em', lineHeight: 1.75, color: 'rgba(255,255,255,0.65)', maxWidth: '280px', marginTop: '1.75rem', textTransform: 'uppercase' }}>
              {c.bonusSub}
            </p>
          </div>
        </div>
