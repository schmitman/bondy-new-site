      ...
      <section id="talent-os" style={{ background: '#0E0E0E', padding: '8rem clamp(1.5rem,5vw,3rem)', position: 'relative', overflow: 'hidden', scrollMarginTop: '60px' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '2rem' }}>
            ...
            <Link href={lk('/contact')} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', fontFamily: 'DM Mono, monospace', fontSize: '10px', letterSpacing: '.13em', textTransform: 'uppercase', background: '#C06A2D', color: '#fff', padding: '13px 26px', textDecoration: 'none', whiteSpace: 'nowrap', flexShrink: 0 }}>
