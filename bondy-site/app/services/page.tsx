    ...
    <main className="bg-b-black min-h-screen">
      ...
      <section className="pt-[73px] border-b border-white/10">
        <div className="px-8 md:px-16 py-20 md:py-28">
          ...
          <p className="text-b-mid text-[17px] leading-relaxed font-light max-w-xl">
            ...
            <div className="space-y-8">
              {[
                ...
                <div key={label} className="border-l-2 border-b-orange/30 pl-5">
                  <div className="font-mono-bondy text-[11px] tracking-wider uppercase text-b-orange mb-2">{label}</div>
                  <p className="text-b-mid text-[15px] font-light leading-relaxed">{text}</p>
                </div>
              ))}
            </div>
            <Link
              href="/contact"
              className="mt-12 inline-flex items-center gap-3 bg-b-orange text-b-black font-mono-bondy text-[11px] tracking-wider uppercase px-7 py-4 hover:bg-b-orange/90 transition-colors self-start"
            >
              Start a search ↗
            </Link>
          </div>
      ...
      <section id="pipeline" className="border-b border-white/10">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="px-8 md:px-16 py-20 flex flex-col justify-between">
            ...
            <Link
              href="/contact"
              className="mt-12 inline-flex items-center gap-3 border border-white/20 text-b-mid font-mono-bondy text-[11px] tracking-wider uppercase px-7 py-4 hover:border-white/40 hover:text-b-off transition-colors self-start"
            >
              Learn more →
            </Link>
          </div>
      ...
      <section className="px-8 md:px-16 py-24 text-center">
        ...
        <p className="text-b-mid text-[16px] font-light mb-10 max-w-md mx-auto leading-relaxed">
