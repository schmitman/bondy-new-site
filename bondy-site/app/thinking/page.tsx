    ...
    <main style={{background: BG}} className="min-h-screen">
      ...
      <section className="pt-[73px] border-b" style={{borderColor: RULE, background: WHITE}}>
        <div className="px-8 md:px-16 py-20 md:py-28">
          ...
          <h1 className="font-display text-[clamp(48px,6vw,72px)] font-black leading-tight tracking-tight mb-6" style={{color: INK}}>
            Ideas, frameworks,<br />
            and <em className="italic" style={{color: SIE}}>market intelligence.</em>
          </h1>
      ...
      <section style={{background: BG}}>
        {articles.map((article, i) => (
          <article
            key={article.slug}
            className="px-8 md:px-16 py-12 grid grid-cols-1 md:grid-cols-[200px_1fr] gap-8 transition-colors cursor-pointer border-b"
            style={{
              borderColor: RULE,
          ...
          >
            <div className="flex flex-row md:flex-col justify-between md:justify-start gap-4 md:gap-3">
              <div className="font-mono-bondy text-[10px] tracking-widest uppercase" style={{color: SIE}}>{article.label}</div>
              <div className="font-mono-bondy text-[10px] tracking-widest" style={{color: '#C8C2BA'}}>{article.date}</div>
            </div>
            <div>
              <h2 className="font-display text-2xl md:text-3xl font-bold leading-tight tracking-tight mb-4" style={{color: INK}}>
                {article.title}
              </h2>
              <p className="text-[14px] leading-relaxed font-light mb-6" style={{color: MID}}>
                {article.excerpt}
              </p>
              <div className="flex items-center gap-4">
                ...
                <span className="font-mono-bondy text-[10px]" style={{color: '#C8C2BA'}}>
