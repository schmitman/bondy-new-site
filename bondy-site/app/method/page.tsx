...
export default function MethodPage() {
  return (
    <main style={{background: BG}} className="min-h-screen">
      ...
      {/* Header */}
      <section className="pt-[73px] border-b" style={{borderColor: RULE, background: WHITE}}>
      ...
      <section className="px-8 md:px-16 py-20" style={{background: BG}}>
        {[
          ...
          >
            <div className="font-mono-bondy text-[11px] tracking-widest" style={{color: SIE}}>
              {step.n}
            </div>
            <div>
              <h2 className="font-display text-3xl md:text-4xl font-bold tracking-tight mb-3" style={{color: INK}}>
                {step.title}
              </h2>
              <div className="text-base font-medium mb-5" style={{color: INK}}>
                {step.subtitle}
              </div>
              <p className="text-[14px] leading-relaxed font-light max-w-xl" style={{color: MID}}>
                {step.body}
              </p>
            </div>
            <div className="flex md:justify-end md:items-start">
              <div className="border px-4 py-2 inline-block" style={{borderColor: RULE}}>
                <div className="font-mono-bondy text-[9px] tracking-widest uppercase mb-1" style={{color: '#C8C2BA'}}>Timeline</div>
                <div className="font-mono-bondy text-[11px]" style={{color: MID}}>{step.time}</div>
              </div>
            </div>
          </div>
        ))}
      ...
      {/* Bottom CTA */}
      <section className="px-8 md:px-16 py-20 md:py-28 border-t" style={{borderColor: RULE, background: WHITE}}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="font-display text-[clamp(32px,4vw,52px)] font-black leading-tight tracking-tight" style={{color: INK}}>
              Ready to run your<br />
              first <em className="italic" style={{color: SIE}}>Bondy search?</em>
            </h2>
          </div>
          <div>
            <p className="text-[15px] leading-relaxed font-light mb-8" style={{color: MID}}>
            ...
            <a
              href="/contact"
              className="inline-flex items-center gap-3 font-mono-bondy text-[11px] tracking-widest uppercase px-8 py-4 hover:opacity-90 transition-opacity text-white"
